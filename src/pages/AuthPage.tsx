  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row" style={{ background: 'linear-gradient(160deg, #020509 0%, #050a16 100%)' }}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-teal-600/4 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-sky-600/3 blur-[100px]" />
      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden border-r border-white/5">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-900/10 via-transparent to-sky-900/10" />
        ...
        <div className="z-10 absolute top-[18%] left-[12%] glass-card !rounded-3xl w-20 h-20 !p-0 flex items-center justify-center animate-float-slow">
          <Database className="text-teal-400" size={32} strokeWidth={1.5} />
        </div>
        <div className="z-10 absolute bottom-[22%] right-[16%] glass-card !rounded-3xl w-28 h-28 !p-0 flex items-center justify-center animate-float-medium" style={{animationDelay:'2s'}}>
          <BrainCircuit className="text-sky-400" size={44} strokeWidth={1.5} />
        </div>
        <div className="z-10 absolute top-[55%] left-[8%] glass-card !rounded-2xl w-14 h-14 !p-0 flex items-center justify-center animate-float-slow" style={{animationDelay:'4s'}}>
          <Activity className="text-emerald-400" size={24} strokeWidth={1.5} />
        </div>
        ...
        <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.8}} className="z-10 text-center relative px-12">
          <div className="w-28 h-28 bg-gradient-to-tr from-teal-600 to-sky-500 rounded-[2rem] flex items-center justify-center mx-auto mb-10 relative overflow-hidden hover:scale-105 transition-transform duration-500" style={{ boxShadow: '0 0 60px rgba(13,148,136,0.3)' }}>
          ...
          <div className="mt-12 flex flex-col gap-3">
            {[
              ...
              { label: 'FDA Grade Accuracy', color: 'badge-emerald' },
              { label: '2.4M+ Drug Database', color: 'badge-sky' },
            ].map(b => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 min-h-screen relative z-10">
        <motion.div initial={{opacity:0,x:20}} animate={{opacity:1,x:0}} transition={{duration:0.6}} className="w-full max-w-[420px]">
          <div className="glass-card !rounded-3xl p-8 sm:p-10 border-white/10 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-48 h-48 bg-teal-500/4 rounded-full blur-[60px] pointer-events-none" />
            ...
            <form className="space-y-4 relative z-10" onSubmit={handleSubmit}>
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <Mail size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/25 group-focus-within:text-teal-400 transition-colors pointer-events-none" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <Lock size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/25 group-focus-within:text-teal-400 transition-colors pointer-events-none" />
                ...
                <div className="flex justify-between items-center pt-1">
                  <label className="flex items-center gap-2.5 cursor-pointer group">
                    <div className="w-4 h-4 rounded-md border border-white/15 bg-white/5 relative flex items-center justify-center">
                      ...
                      <div className="w-2 h-2 rounded-sm bg-teal-500 opacity-0 peer-checked:opacity-100 transition-opacity" />
                    </div>
                    <span className="text-xs font-semibold text-white/35 group-hover:text-white/60 transition-colors">Maintain Session</span>
                  </label>
                  <a href="#" className="text-xs font-bold text-teal-400 hover:text-teal-300 transition-colors">Recover Key</a>
                </div>
              )}
            ...
            <div className="mt-6 text-center border-t border-white/6 pt-5 relative z-10">
              <p className="text-xs text-white/25 font-semibold">
                ...
                <button type="button" onClick={() => setIsSignUp(!isSignUp)} className="text-teal-400 hover:text-teal-300 transition-colors ml-1 font-bold">
